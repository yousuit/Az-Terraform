...
# ── FEATURE FLAGS ─────────────────────────────────────────────
variable "enable_app_service"        { type = bool; default = true }
variable "enable_function_app"       { type = bool; default = true }
variable "enable_storage"            { type = bool; default = true }
variable "enable_redis"              { type = bool; default = true }
variable "enable_sql_db"             { type = bool; default = true }
variable "enable_sql_mi"             { type = bool; default = false }
...
variable "enable_search"             { type = bool; default = true }
variable "enable_speech"             { type = bool; default = true }
variable "enable_databricks"         { type = bool; default = false }
variable "enable_mysql_flexible"     { type = bool; default = true }
variable "enable_postgresql"         { type = bool; default = true }
variable "enable_cosmosdb_nosql"     { type = bool; default = true }
variable "enable_cosmosdb_mongo"     { type = bool; default = false }
variable "enable_ai_vision"          { type = bool; default = true }
variable "enable_ai_foundry"         { type = bool; default = false }
variable "enable_bing_search"        { type = bool; default = false }
variable "enable_container_instance" { type = bool; default = false }
...
variable "function_app_sku"   { type = string;       default = "EP1" }
...
variable "redis_sku"      { type = string; default = "Standard" }
...
variable "sql_mi_sku"        { type = string; default = "GP_Gen5" }
variable "sql_mi_vcores"     { type = number; default = 4 }
variable "sql_mi_storage_gb" { type = number; default = 32 }

variable "service_bus_sku"    { type = string;       default = "Premium" }
variable "service_bus_queues" { type = list(string); default = [] }
variable "service_bus_topics" { type = list(string); default = [] }
...
variable "search_sku" { type = string; default = "standard" }

# MySQL Flexible — VNet injection (delegated subnet), not a private endpoint
variable "mysql_admin_login"    { type = string; default = "mysqladmin" }
variable "mysql_admin_password" { type = string; sensitive = true; default = "" }
variable "mysql_sku_name"       { type = string; default = "Standard_D2ds_v4" }
variable "mysql_version"        { type = string; default = "8.0.21" }
variable "mysql_storage_gb"     { type = number; default = 32 }

# PostgreSQL Flexible — VNet injection (delegated subnet), not a private endpoint
variable "postgresql_admin_login"    { type = string; default = "psqladmin" }
variable "postgresql_admin_password" { type = string; sensitive = true; default = "" }
variable "postgresql_sku_name"       { type = string; default = "Standard_D2s_v3" }
variable "postgresql_version"        { type = string; default = "14" }  # maps to pg_version in module
variable "postgresql_storage_mb"     { type = number; default = 32768 }
